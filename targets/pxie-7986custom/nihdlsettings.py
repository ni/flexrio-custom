...
def pre_all(context):
    ...
    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pxie-7986"
    plugin_name = "PXIe-7986Custom"
    ...
    config.set_vivado_top_entity("AppletonTopTemplate")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/Appleton7986.xml.mako")
