...
def pre_all(context):
    ...
    config.set_vivado_project_folder("VivadoProject/My7985Proj.xpr")
    ...
    config.set_lv_target_plugin_output_folder("objects/LVTargetPlugin/PXIe-7985Custom")
    ...
    config.set_lv_window_vivado_project_export_xpr("C:/temp/customwindow/7985_VPE/VivadoProject/Running8.xpr")
    ...
    # --- ModelSim Settings ---
    config.set_modelsim_project_folder("ModelSimProject/My7985Proj.mpf")
