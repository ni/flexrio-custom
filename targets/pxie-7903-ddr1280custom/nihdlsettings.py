...
def pre_all(context):
    ...
    config.set_vivado_project_folder("VivadoProject/My7903Ddr1280Proj.xpr")
    ...
    config.set_lv_target_plugin_output_folder("objects/LVTargetPlugin/PXIe-7903-DDR1280Custom")
    ...
    # --- ModelSim Settings ---
    config.set_modelsim_project_folder("ModelSimProject/My7903Ddr1280Proj.mpf")
