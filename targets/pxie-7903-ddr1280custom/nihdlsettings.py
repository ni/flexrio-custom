...
def pre_all(context):
    ...
    config.set_vivado_project_path("VivadoProject/My7903Ddr1280Proj.xpr")

    config.add_hdl_file_list("../../deps/flexrio/targets/pxie-7903-ddr1280/vivadoprojectdeps.txt")
    config.add_hdl_file_list("vivadoprojectsources.txt")

    config.add_constraints_template(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/xdc/constraints.xdc_template"
    )
    config.set_custom_constraints_file("xdc/custom_constraints.xdc")
    config.add_vivado_project_constraints_file(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/xdc/constraints_place.xdc"
    )
    ...
    config.set_code_generation_results_stub(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/lvFpgaTarget/CodeGenerationResultsStub.lvtxt"
    )
    ...
    config.set_lv_target_info_ini(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/lvFpgaTarget/TargetInfo.ini"
    )
    config.set_lv_target_exclude_files(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/lvtargetexcludefiles.txt"
    )
    config.set_max_hdl_reg_offset(16)

    # Templates
    config.add_window_vhdl_template(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/rtl-lvfpga/lvgen/TheWindow.vhd.mako"
    )
    ...
    config.add_target_xml_template(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/lvFpgaTarget/Resource.xml.mako"
    )
    config.add_target_xml_template(
        "../../deps/flexrio/targets/pxie-7903-ddr1280/lvFpgaTarget/Sasquatch7903DDR1280.xml.mako"
    )
    ...
    config.set_lv_target_plugin_folder("objects/LVTargetPlugin/PXIe-7903-DDR1280Custom")
    config.set_boardio_output("objects/LVTargetPlugin/PXIe-7903-DDR1280Custom/boardio.xml")
    config.set_clock_output("objects/LVTargetPlugin/PXIe-7903-DDR1280Custom/CustomClocks.xml")
    ...
    config.set_vivado_project_export_xpr(
        "C:/temp/customwindow/7903_DDR1280_VPE/VivadoProject/Running5.xpr"
    )
    config.set_the_window_folder_output("objects/TheWindow")

    # --- ModelSim Settings ---
    config.set_modelsim_project_path("ModelSimProject/My7903Ddr1280Proj.mpf")
