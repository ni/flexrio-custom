...
def pre_all(context):
    ...
    config.set_vivado_project_folder("VivadoProject/My7915Proj.xpr")
    ...
    config.set_lv_target_plugin_output_folder("objects/LVTargetPlugin/PXIe-7915Custom")
    ...
    config.set_lv_window_vivado_project_export_xpr("C:/temp/customwindow/7915_VPE/VivadoProject/Running3.xpr")
    config.set_lv_window_netlist_output_folder("objects/TheWindowRunning")
    ...
    # --- ModelSim Settings ---
    config.set_modelsim_project_folder("ModelSimProject/My7915Proj.mpf")
