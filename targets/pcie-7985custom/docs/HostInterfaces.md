# PXIe-7985 Custom Target â€” Host Interfaces (Register & FIFO API)

Host-facing API reference for the PXIe-7985 **custom** target: every
...
|--------|------|--------|-------------|
| `0x00` | Signature | RO | Fixed signature (`0x7985BEEF`) |
