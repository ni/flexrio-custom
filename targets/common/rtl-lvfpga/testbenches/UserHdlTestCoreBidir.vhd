...
--
-- Purpose:
--   DUT wrapper for targets whose UserHdl exposes the bidirectional aux-DIO
--   handshake (bdDone / bdDirection / bdRequest). It declares the testbench
--   signals, generates the clocks, instantiates work.UserHdl and runs the
--   single-sourced stimulus from work.PkgUserHdlTest. The companion
--   UserHdlTestCoreSimple covers targets with the plain aux interface.
--
-------------------------------------------------------------------------------
...
entity UserHdlTestCoreBidir is
  generic (
...
end entity UserHdlTestCoreBidir;

architecture sim of UserHdlTestCoreBidir is
