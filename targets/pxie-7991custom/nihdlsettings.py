"""nihdlsettings.py - Target settings for pxie-7991custom."""


def pre_all(context):
    """Configure all settings for pxie-7991custom."""
    config = context.config

    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pxie-7991"
    plugin_name = "PXIe-7991Custom"
    ...
    config.set_base_target("PXIe-7991")
    ...
    config.set_lv_target_name("PXIe-7991Custom")
    config.set_lv_target_guid("73d055ce-dd6a-40ae-a150-f6b4697903cf")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/BTrace7991.xml.mako")
