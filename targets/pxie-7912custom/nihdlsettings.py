...
def pre_all(context):
    ...
    config.set_lv_window_vivado_project_export_xpr(r"C:\temp\GH15_FIFO_VI_VPE\VivadoProject\FPGA_VI_FIFO_2.xpr")
    config.set_lv_window_netlist_output_folder("objects/FPGA_VI_FIFO_2")
