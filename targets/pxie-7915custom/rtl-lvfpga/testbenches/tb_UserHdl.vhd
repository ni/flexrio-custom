...
--
-- Purpose:
--   Smoke/integration testbench for the PXIe-7915 custom target's UserHdl.
--
...
--   here (inputs to a constant, outputs left open).
--
-------------------------------------------------------------------------------
...
begin
  ...
  DUT : entity work.UserHdl
    port map(
      ...
      -- Board IO: not exercised in simulation; inputs tied off, outputs open.
