"""nihdlsettings.py - Target settings for pxie-7993custom."""


def pre_all(context):
    """Configure all settings for pxie-7993custom."""
    config = context.config

    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pxie-7993"
    plugin_name = "PXIe-7993Custom"
    ...
    config.set_xilinx_sim_lib_folder("../../objects/sim_library/kintexuplus")
    config.add_xilinx_sim_library("unisim")
    config.set_xilinx_sim_family("kintexuplus")

    # --- General Settings ---
    config.set_target_family("FlexRIO")
    config.set_base_target("PXIe-7993")
    ...
    config.set_vivado_top_entity("BlackadderTopTemplate")
    config.set_fpga_part("xcku11p-ffva1156-2-e")
    ...
    config.set_lv_target_name("PXIe-7993Custom")
    config.set_lv_target_guid("786d61b3-36b6-4541-ab0b-6dfd2c7fd410")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/Blackadder7993.xml.mako")
