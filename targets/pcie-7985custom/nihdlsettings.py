"""nihdlsettings.py - Target settings for pcie-7985custom."""


def pre_all(context):
    """Configure all settings for pcie-7985custom."""
    config = context.config

    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pcie-7985"
    plugin_name = "PCIe-7985Custom"
    ...
    config.set_base_target("PCIe-7985")
    ...
    config.set_lv_target_name("PCIe-7985Custom")
    config.set_lv_target_guid("173e95bb-a4b3-4a3d-bf8b-c6d6b0d95d08")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/Garrison7985.xml.mako")
