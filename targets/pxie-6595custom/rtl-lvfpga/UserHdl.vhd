...
--
-- Purpose:
--   User-facing HDL block for the PXIe-6595 (Coruba) custom target.
--
--   Instantiates:
...
entity UserHdl is
  port(
    ...
    -- TheLvWindowFlatWrapper for this target. Coruba (PXIe-6595) has no Aux
    -- DIO IO-Node; its board IO is the socketed CLIP plus a JESD204 / MGT
    -- frontend, all tied off / released below.
    -----------------------------------
    -- CLIP Socket ports
    -----------------------------------
    ...
    -----------------------------------
    -- MGT / JESD204 frontend ports (board-specific to Coruba / PXIe-6595)
    -----------------------------------
    ...
    -----------------------------------
    -- PCIe DRP socket (GT dynamic reconfiguration)
    -----------------------------------
...
begin
  ...
  ---------------------------------------------------------------------------
  -- Board IO -- all tied off / released (user-extendable placeholder)
  ---------------------------------------------------------------------------
  ...
  -- here instead. Coruba (PXIe-6595) exposes the socketed-CLIP interface plus a
  -- JESD204 / MGT frontend. All outputs are driven to an inert default and the
  -- inout buses are released (high-Z); replace these assignments with your
  -- CLIP / transceiver / JESD204 logic to use the board IO.
  ---------------------------------------------------------------------------
