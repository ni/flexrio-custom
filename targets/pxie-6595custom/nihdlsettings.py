"""nihdlsettings.py - Target settings for pxie-6595custom."""


def pre_all(context):
    """Configure all settings for pxie-6595custom."""
    config = context.config

    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pxie-6595"
    plugin_name = "PXIe-6595Custom"
    ...
    config.set_base_target("PXIe-6595")
    ...
    config.set_vivado_top_entity("CorubaTopTemplate")
    config.set_fpga_part("xcku15p-ffve1517-3-e")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/Coruba6595.xml.mako")
