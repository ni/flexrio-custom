...
architecture sim of tb_UserHdl is
  ...
  constant kSignature : std_logic_vector(31 downto 0) := x"7912BEEF";
...
begin
  ...
  begin
    ...
    -------------------------------------------------------------------------
    -- SECTION 4: Board IO defaults
    -------------------------------------------------------------------------
    report "SECTION 4: board IO default drive" severity note;
    assert aLvAuxDioOutputEnable = (aLvAuxDioOutputEnable'range => '0')
      report "AuxDio OutputEnable default should be all zero" severity error;
    assert aLvAuxDioOutputData = (aLvAuxDioOutputData'range => '0')
      report "AuxDio OutputData default should be all zero" severity error;
