...
def pre_all(context):
    ...
    config.set_vivado_project_folder("VivadoProject/My7981Proj.xpr")
    ...
    config.set_lv_target_plugin_output_folder("objects/LVTargetPlugin/PXIe-7981Custom")
    ...
    # --- ModelSim Settings ---
    config.set_modelsim_project_folder("ModelSimProject/My7981Proj.mpf")
