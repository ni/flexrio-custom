...
--
-- Purpose:
--   User-facing HDL block for the PXIe-7982 custom target.
--
--   Instantiates:
...
begin
  ...
  ---------------------------------------------------------------------------
  -- The 8 Aux DIO IO-Node interfaces are exposed to the host as three
  -- registers (see PkgUserHdl, docs/HostInterfaces.md, and the common FlexRIO Digital IO document ../../../docs/DigitalIO.md):
