"""nihdlsettings.py - Target settings for pxie-7915custom."""


def pre_all(context):
    """Configure all settings for pxie-7915custom."""
    ...
    config.set_base_target("PXIe-7915")
    ...
    config.set_vivado_project_path("VivadoProject/My7915Proj.xpr")

    config.add_hdl_file_list("../../deps/flexrio/targets/pxie-7915/vivadoprojectdeps.txt")
    config.add_hdl_file_list("vivadoprojectsources.txt")

    config.add_constraints_template("../../deps/flexrio/targets/pxie-7915/xdc/constraints.xdc")
    config.set_custom_constraints_file("xdc/custom_constraints.xdc")
    config.add_vivado_project_constraints_file(
        "../../deps/flexrio/targets/pxie-7915/xdc/constraints_place.xdc"
    )
    ...
    config.set_code_generation_results_stub(
        "../../deps/flexrio/targets/pxie-7915/lvFpgaTarget/CodeGenerationResultsStub.lvtxt"
    )
    ...
    config.set_lv_target_name("PXIe-7915Custom")
    config.set_lv_target_guid("9b5b96a6-5de7-464f-93ce-e783ce3b16bf")
    ...
    config.add_lv_target_constraints_file(
        "../../deps/flexrio/targets/pxie-7915/xdc/constraints.xdc"
    )
    config.add_lv_target_constraints_file(
        "../../deps/flexrio/targets/pxie-7915/xdc/constraints_place.xdc"
    )
    ...
    config.set_lv_target_info_ini(
        "../../deps/flexrio/targets/pxie-7915/lvFpgaTarget/TargetInfo.ini"
    )
    config.set_lv_target_exclude_files(
        "../../deps/flexrio/targets/pxie-7915/lvtargetexcludefiles.txt"
    )
    config.set_max_hdl_reg_offset(16)

    # Templates
    config.add_window_vhdl_template(
        "../../deps/flexrio/targets/pxie-7915/rtl-lvfpga/lvgen/TheWindow.vhd.mako"
    )
    ...
    config.add_target_xml_template(
        "../../deps/flexrio/targets/pxie-7915/lvFpgaTarget/Resource.xml.mako"
    )
    config.add_target_xml_template(
        "../../deps/flexrio/targets/pxie-7915/lvFpgaTarget/Macallan7915.xml.mako"
    )
    ...
    config.set_lv_target_plugin_folder("objects/LVTargetPlugin/PXIe-7915Custom")
    config.set_boardio_output("objects/LVTargetPlugin/PXIe-7915Custom/boardio.xml")
    config.set_clock_output("objects/LVTargetPlugin/PXIe-7915Custom/CustomClocks.xml")
    ...
    config.set_vivado_project_export_xpr("C:/temp/customwindow/7915_VPE/VivadoProject/Running3.xpr")
    config.set_the_window_folder_output("objects/TheWindowRunning")

    # --- ModelSim Settings ---
    config.set_modelsim_project_path("ModelSimProject/My7915Proj.mpf")
