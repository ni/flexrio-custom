"""nihdlsettings.py - Target settings for pcie-7982custom."""


def pre_all(context):
    """Configure all settings for pcie-7982custom."""
    config = context.config

    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pcie-7982"
    plugin_name = "PCIe-7982Custom"
    ...
    config.set_base_target("PCIe-7982")
    ...
    config.set_lv_target_name("PCIe-7982Custom")
    config.set_lv_target_guid("eef5e498-7cf2-46ee-95bf-b0c2c11b4974")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/Garrison7982.xml.mako")
