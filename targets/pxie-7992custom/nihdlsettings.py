"""nihdlsettings.py - Target settings for pxie-7992custom."""


def pre_all(context):
    """Configure all settings for pxie-7992custom."""
    config = context.config

    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pxie-7992"
    plugin_name = "PXIe-7992Custom"
    ...
    config.set_base_target("PXIe-7992")
    ...
    config.set_lv_target_name("PXIe-7992Custom")
    config.set_lv_target_guid("8c71b12a-9ee8-49b6-8786-29e14910503f")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/BTrace7992.xml.mako")
