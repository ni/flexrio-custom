"""nihdlsettings.py - Target settings for pcie-7981custom."""


def pre_all(context):
    """Configure all settings for pcie-7981custom."""
    config = context.config

    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pcie-7981"
    plugin_name = "PCIe-7981Custom"
    ...
    config.set_base_target("PCIe-7981")
    ...
    config.set_vivado_top_entity("GarrisonTop")
    ...
    config.set_lv_target_name("PCIe-7981Custom")
    config.set_lv_target_guid("8437f90f-8487-4b3e-a3a5-bb7456c6aef3")
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/Garrison7981.xml.mako")
