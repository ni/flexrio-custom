...
def pre_all(context):
    ...
    # --- Settings Variables ---
    base_deps = "../../deps/flexrio/targets/pxie-7994"
    plugin_name = "PXIe-7994Custom"
    ...
    config.add_lv_target_xml_template(f"{base_deps}/lvFpgaTarget/BTracePlus7994.xml.mako")
    ...
    config.set_lv_window_vivado_project_export_xpr("C:/temp/customwindow/7994_VPE/VivadoProject/Running10.xpr")
