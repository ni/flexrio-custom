...
def pre_all(context):
    ...
    config.set_vivado_project_path("VivadoProject/My7994Proj.xpr")
    ...
    config.set_code_generation_results_stub(
        "../../deps/flexrio/targets/pxie-7994/lvFpgaTarget/CodeGenerationResultsStub.lvtxt"
    )
    ...
    config.set_lv_target_plugin_folder("objects/LVTargetPlugin/PXIe-7994Custom")
    ...
    # --- ModelSim Settings ---
    config.set_modelsim_project_path("ModelSimProject/My7994Proj.mpf")
