...
def pre_all(context):
    ...
    config.set_lv_window_netlist_folder("objects/TheWindowRunningFifos_NoHdlFIFOs_3_Hack_2")
    ...
    config.set_lv_window_vivado_project_export_xpr("C:/temp/7912Cust_VPE_NoHdlFIFOs_3_Hack_2/VivadoProject/CustomBlankRunning.xpr")
    config.set_lv_window_netlist_output_folder("objects/TheWindowRunningFifos_NoHdlFIFOs_3_Hack_2")
