# PXIe-7986 Custom Target â€” Host Interfaces (Register & FIFO API)

Host-facing API reference for the PXIe-7986 **custom** target: every
...
|--------|------|--------|-------------|
| `0x00` | Signature | RO | Fixed signature (`0x7986BEEF`) |
